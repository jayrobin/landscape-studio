...
/**
 * Hybrid additive/multiplicative multifractal terrain generation algorithm
 * Original code by Carl Burke, adapted by James Robinson
 * 
 * @author James Robinson 
 * @version 1.0
 */
public class ALGHMF implements IAlgorithm, ActionListener, ChangeListener
{
    ...
    public void setPanel(JPanel panel)
    {
        ...
        sldLacunarity = new JSlider(0, 100, 50);   // Divide by 10
        ...
        sldOffset = new JSlider(0, 2000, 70);   // Divide by 100
        ...
        btnGenerate = new JButton("Generate HMF");
     ...
     * 
     * @return int[][] The HMF heightmap
     */
    private int[][] generateTerrain(boolean apreview)
    {
        ...
        for (int i = 0; i < heightmap.length; i++) {
            for (int j = 0; j < heightmap[i].length; j++) {
                ...
                point[2] = z;
                heightmap[i][j] = (hmf(point, 0.5, lacunarity, octaves, offset));
            }
     ...
     */
    private double hmf( double point[], double H, double lacunarity, double octaves, double offset )
    {
        ...
        for (i=1; i < octaves; i++)
        {
            ...
            //signal = ( Math.abs(noise3( point )) + offset ) * exponent_array[i];
    ...
    {
        return "Hybrid Additive/Multiplicative Multi-Fractal";
    }
