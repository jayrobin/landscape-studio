...
/**
 * Heterogeneous Procedural Terrain algorithm
 * Original code by Carl Burke, adapted by James Robinson
 * 
 * @author James Robinson 
 * @version 1.0
 */
public class ALGHetero implements IAlgorithm, ActionListener, ChangeListener
{
    ...
    public void setPanel(JPanel panel)
    {
        ...
        sldOffset = new JSlider(0, 2000, 100);   // Divide by 100
        ...
        btnGenerate = new JButton("Generate Hetero-fractal");
    ...
    private int[][] generateTerrain(boolean preview)
    {
        ...
        for (int i = 0; i < heightmap.length; i++) {
            for (int j = 0; j < heightmap[i].length; j++) {
                ...
                point[2] = z;
                heightmap[i][j] = (hetero(point, h, lacunarity, octaves, offset));
            }
     ...
     */
    private double hetero( double point[], double H, double lacunarity, double octaves, double offset )
    {
    ...
    {
        return "Heterogeneous Procedural Fractal";
    }
